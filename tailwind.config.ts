    ...
    extend: {
      ...
      keyframes: {
        ...
        "pulse-ring": {
          ...
          "70%": { transform: "scale(1)", boxShadow: "0 0 0 15px hsl(var(--primary) / 0)" },
      ...
      animation: {
        ...
        "shake-attention": "shake-attention 0.5s ease-in-out",
        "bounce-enter": "bounce-enter 0.6s ease-out forwards",
