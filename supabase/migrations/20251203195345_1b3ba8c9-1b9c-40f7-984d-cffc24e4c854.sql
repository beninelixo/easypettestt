...
-- Corrigir URL do projeto nas funções SQL
-- Atualizando de xkfkrdorghyagtwbxory para zxdbsimthnfprrthszoh

-- Recriar função notify_appointment_change com URL correta
...
-- Recriar função handle_new_user com URL correta
