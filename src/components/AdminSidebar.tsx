...
const monitoringItems = [
  ...
  { title: "Performance History", url: "/admin/performance-history", icon: LineChart },
  ...
  { title: "Métricas de Auth", url: "/admin/auth-metrics", icon: BarChart },
  { title: "System Health", url: "/admin/system-health", icon: Gauge },
  { title: "Integridade de Dados", url: "/admin/data-integrity", icon: FileText },
