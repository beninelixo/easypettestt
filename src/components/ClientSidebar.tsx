...
import { PawPrint, Calendar, CalendarCheck, User, LogOut, LayoutDashboard, History } from "lucide-react";
import {
  Sidebar,
  SidebarContent,
  SidebarGroup,
...
const clientMenuItems = [
  ...
  { title: "Histórico", url: "/client/history", icon: History, tourId: "history-menu" },
