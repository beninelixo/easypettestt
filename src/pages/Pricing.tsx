              ...
              <table className="w-full border-collapse bg-card rounded-xl overflow-hidden shadow-lg">
                ...
                <tbody className="divide-y">
                  {[
                    ...
                    { name: "Relatórios financeiros", gold: "Básicos", platinum: "Avançados", annual: "Avançados" },
                    { name: "Lembretes automáticos", gold: "Email", platinum: "Email + WhatsApp", annual: "Email + WhatsApp" },
                    { name: "Programa de fidelidade", gold: false, platinum: true, annual: true },
                    { name: "API para integrações", gold: false, platinum: true, annual: true },
